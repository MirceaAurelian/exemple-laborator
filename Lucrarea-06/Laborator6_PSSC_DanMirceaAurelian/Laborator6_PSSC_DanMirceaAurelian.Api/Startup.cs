using Laborator6_PSSC_DanMirceaAurelian.Data;
using Laborator6_PSSC_DanMirceaAurelian.Data.Repositories;
using Laborator6_PSSC_DanMirceaAurelian.Events;
using Laborator6_PSSC_DanMirceaAurelian.Events.ServiceBus;
using Laborator6_PSSC_DanMirceaAurelian.Domain;
...
namespace Laborator6_PSSC_DanMirceaAurelian.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Laborator6_PSSC_DanMirceaAurelian.Api", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Laborator6_PSSC_DanMirceaAurelian.Api v1"));
            }
