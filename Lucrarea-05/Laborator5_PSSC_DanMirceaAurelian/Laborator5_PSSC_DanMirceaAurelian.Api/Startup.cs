...
using Laborator5_PSSC_DanMirceaAurelian.Data.Repositories;
...
namespace Laborator5_PSSC_DanMirceaAurelian.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Laborator5_PSSC_DanMirceaAurelian.Api", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Laborator5_PSSC_DanMirceaAurelian.Api v1"));
            }
